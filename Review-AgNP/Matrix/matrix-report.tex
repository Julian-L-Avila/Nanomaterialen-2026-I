...
revela un sesgo profundo hacia la ingeniería aplicada y la biomedicina.
La mayoría de los estudios abordan aplicaciones macroscópicas y operativas, tales
...
Para abordar esta brecha e identificar investigaciones fundamentales recientes,
la metodología fue actualizada. La primera fase de la búsqueda fue general, mientras
que la segunda fase utilizó operadores lógicos restrictivos (AND) para encontrar la
intersección exacta entre los nanomateriales y la óptica no lineal. Los parámetros
lógicos y cronológicos (2020--2026) que estructuran la matriz de revisión son los siguientes:

\begin{itemize}
	\item Fase 1 (Búsqueda general): \enquote{Silver nanoparticles} OR \enquote{AgNPs}
		\begin{itemize}
		...
		\end{itemize}
	\item Fase 2 (Actualización restrictiva): (\enquote{Silver nanoparticles} OR \enquote{AgNPs}) AND \enquote{Nonlinear Optics}
		\begin{itemize}
			\item Science Direct: 19 resultados
			\item Springerlink: 8 resultados
		\end{itemize}
\end{itemize}
...
\begin{landscape}
	...
	\begin{table}[htbp!]
		...
		\begin{tabularx}{\linewidth}{
			...
			electrónicas de las AgNPs respecto a su método de síntesis.
			Argumenta la superioridad de las rutas biológicas debido a su
			estabilidad intrínseca y baja reactividad parásita. &
			...
			viabilidad de la síntesis verde mediada por fitoquímicos. &
			Scopus \\
			\bottomrule
		\end{tabularx}
	\end{table}
...
\begin{landscape}
	...
	\begin{table}[htbp!]
		...
		\begin{tabularx}{\linewidth}{
			...
			Metodología del artículo & Base \\
			\midrule
			Optical Properties and Applications of Metal Nanomaterials in Ultrafast
			Photonics: A Review - 2024 \cite{chaoOpticalPropertiesApplications2024} &
			Chao, J. et al. &
			Journal of Materials Science &
			Revisa los principios operativos de nanomateriales metálicos en láseres
			ultrarrápidos, enfatizando la absorción saturable y la resonancia de
			plasmón superficial. &
			Clasificación sistemática según la estructura dimensional de los materiales
			y análisis de parámetros operativos para absorbedores saturables. &
			Springerlink \\
			\addlinespace
			Moringa Oleifera: A Plethora of Bioactive Reservoirs with Tremendous
			Opportunity for Green Synthesis of Silver Nanoparticles...
			- 2024 \cite{nagimeMoringaOleiferaPlethora2024} &
			Nagime, P. V. et al. &
			Nano-Structures \& Nano-Objects &
			Explora la síntesis verde de AgNPs utilizando extractos de Moringa oleifera
			para eludir el uso de materiales peligrosos, destacando sus aplicaciones
			antibacterianas. &
			Revisión de procesos de biosíntesis, analizando la función de los
			metabolitos vegetales como agentes reductores y estabilizadores. &
			Science Direct \\
			\addlinespace
