...
\title[]{Ontología física y política científica de la nanotecnología}
...
\abstract{
  Este ensayo analiza las deficiencias epistemológicas y sociopolíticas en la
...
\input{./sections/feynman-myth.tex}

\input{./sections/nanotech-definition.tex}

\input{./sections/proper-definition.tex}

\input{./sections/application-as-detour.tex}

\input{./sections/conclusion.tex}

\bibliography{./nanotech-essay.bib}
